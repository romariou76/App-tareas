  ...
  const TareasFila = (donevalue) => {
    ...
    return (
      ...
      tareas
        ...
        .map(
          (
            tarea // Por cada tarea que haya devuelva un tr con el nombre y cada tarea debe tener una clave unica en <tr>
          ) => (
            ...
            /> // Pasamos la funcion como prop actualizarTarea porque tiene el checkbox
          )
        )
    );
  };
